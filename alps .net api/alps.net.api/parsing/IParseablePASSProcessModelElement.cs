...
namespace alps.net.api.parsing
{
    ...
    public interface IParseablePASSProcessModelElement : IPASSProcessModelElement, IGraphCallback
    {
        ...
        void addTriples(IList<IIncompleteTriple> triples);
        ...
        void addTriples(IList<Triple> triples);
        ...
        /// They describe connection to other elements etc.
        /// </summary>
        IList<IIncompleteTriple> getIncompleteTriples();
        ...
        /// <returns></returns>
        bool removeTriple(IIncompleteTriple incTriple);
        ...
        /// <returns></returns>
        bool containsTriple(IIncompleteTriple incTriple);
