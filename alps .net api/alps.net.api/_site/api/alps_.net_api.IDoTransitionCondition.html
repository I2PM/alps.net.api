...
<html>
  ...
  <head>
    ...
    <title>Interface IDoTransitionCondition
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Interface IDoTransitionCondition
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="alps_.net_api.IDoTransitionCondition">
  
  
  <h1 id="alps__net_api_IDoTransitionCondition" data-uid="alps_.net_api.IDoTransitionCondition" class="text-break">Interface IDoTransitionCondition
  </h1>
  <div class="markdown level0 summary"><p>Interface to the DoTransitionCondition class</p>
</div>
  <div class="markdown level0 conceptual"></div>
  <div class="inheritedMembers">
    <h5>Inherited Members</h5>
    <div>
      <a class="xref" href="alps_.net_api.ITransitionCondition.html#alps__net_api_ITransitionCondition_setToolSpecificDefiniton_System_String_">ITransitionCondition.setToolSpecificDefiniton(String)</a>
    </div>
    <div>
      <a class="xref" href="alps_.net_api.ITransitionCondition.html#alps__net_api_ITransitionCondition_getToolSpecificDefintion">ITransitionCondition.getToolSpecificDefintion()</a>
    </div>
    <div>
  ...
  <h5 id="alps__net_api_IDoTransitionCondition_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public interface IDoTransitionCondition : ITransitionCondition, IBehaviorDescriptionComponent, IPASSProcessModellElement, IOwlThing</code></pre>
  </div>
  <h3 id="methods">Methods
  </h3>
  
  
  <a id="alps__net_api_IDoTransitionCondition_factoryMethod_" data-uid="alps_.net_api.IDoTransitionCondition.factoryMethod*"></a>
  <h4 id="alps__net_api_IDoTransitionCondition_factoryMethod" data-uid="alps_.net_api.IDoTransitionCondition.factoryMethod">factoryMethod()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">DoTransitionCondition factoryMethod()</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="alps_.net_api.DoTransitionCondition.html">DoTransitionCondition</a></td>
        <td></td>
      </tr>
    </tbody>
  </table>
