...
<html>
  ...
  <head>
    ...
    <title>Interface ICustomOrExternalDataTypeDefintion
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Interface ICustomOrExternalDataTypeDefintion
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="alps_.net_api.ICustomOrExternalDataTypeDefintion">
  
  
  <h1 id="alps__net_api_ICustomOrExternalDataTypeDefintion" data-uid="alps_.net_api.ICustomOrExternalDataTypeDefintion" class="text-break">Interface ICustomOrExternalDataTypeDefintion
  </h1>
  <div class="markdown level0 summary"><p>Interface to the custom or external data type definition class</p>
</div>
  <div class="markdown level0 conceptual"></div>
  <div class="inheritedMembers">
    <h5>Inherited Members</h5>
    <div>
      <a class="xref" href="alps_.net_api.IDataTypeDefintion.html#alps__net_api_IDataTypeDefintion_setContainsDataObjectDefintion_alps__net_api_IDataObjectDefiniton_">IDataTypeDefintion.setContainsDataObjectDefintion(IDataObjectDefiniton)</a>
    </div>
    <div>
      <a class="xref" href="alps_.net_api.IDataTypeDefintion.html#alps__net_api_IDataTypeDefintion_getDataObjectDefiniton">IDataTypeDefintion.getDataObjectDefiniton()</a>
    </div>
    <div>
      <a class="xref" href="alps_.net_api.IDataTypeDefintion.html#alps__net_api_IDataTypeDefintion_factoryMethod">IDataTypeDefintion.factoryMethod()</a>
    </div>
    <div>
  ...
  <h5 id="alps__net_api_ICustomOrExternalDataTypeDefintion_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public interface ICustomOrExternalDataTypeDefintion : IDataTypeDefintion, IDataDescribingComponent, IPASSProcessModellElement, IOwlThing</code></pre>
  </div>
</article>
          </div>
